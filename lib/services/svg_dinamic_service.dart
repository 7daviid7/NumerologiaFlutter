...
class _SvgDynamicRendererState extends State<SvgDynamicRenderer> {
  ...
  Future<void> _loadSvg() async {
    try {
      final String rawSvg =
          await rootBundle.loadString('assets/${widget.svgName}.svg');
  ...
  void _switchCaseComplet(int key, xml.XmlDocument document) {
    switch (key) {
      case SvgIdentifiers.CAP_DRET:
        {
          final xml.XmlElement? bracDretElement =
              _findElementById(document, 'capDret');
      ...
      case SvgIdentifiers.CAP_ESQUERRE:
        {
          final xml.XmlElement? bracDretElement =
              _findElementById(document, 'capEsquerre');
          if (bracDretElement != null) {
            bracDretElement.setAttribute('fill', _pintar);
          }
        }
      case SvgIdentifiers.BRAC_ESQUERRE:
        {
          final xml.XmlElement? bracDretElement =
              _findElementById(document, 'bracEsquerre');
          if (bracDretElement != null) {
            bracDretElement.setAttribute('fill', _pintar);
          }
        }
      case SvgIdentifiers.PANXA_ESQUERRE:
        {
          final xml.XmlElement? bracDretElement =
              _findElementById(document, 'panxaEsquerre');
          if (bracDretElement != null) {
            bracDretElement.setAttribute('fill', _pintar);
          }
        }
      case SvgIdentifiers.CADERA:
        {
          final xml.XmlElement? bracDretElement =
              _findElementById(document, 'cadera');
          if (bracDretElement != null) {
            bracDretElement.setAttribute('fill', _pintar);
          }
        }
      case SvgIdentifiers.CAMA_ESQUERRE:
        {
          final xml.XmlElement? bracDretElement =
              _findElementById(document, 'camaEsquerre');
          if (bracDretElement != null) {
            bracDretElement.setAttribute('fill', _pintar);
          }
        }
      case SvgIdentifiers.CAMA_DRETA:
        {
          final xml.XmlElement? bracDretElement =
              _findElementById(document, 'camaDreta');
          if (bracDretElement != null) {
            bracDretElement.setAttribute('fill', _pintar);
          }
        }
      case SvgIdentifiers.PANXA_DRETA:
        {
          final xml.XmlElement? bracDretElement =
              _findElementById(document, 'panxaDreta');
          if (bracDretElement != null) {
            bracDretElement.setAttribute('fill', _pintar);
          }
        }
      case SvgIdentifiers.BRAC_DRET:
        {
          final xml.XmlElement? bracDretElement =
              _findElementById(document, 'bracDret');
          if (bracDretElement != null) {
            bracDretElement.setAttribute('fill', _pintar);
          }
        }
  ...
  void _switchCaseMeitat(int key, xml.XmlDocument document) {
    switch (key) {
      case SvgIdentifiers.CAP_DRET:
        {
          final xml.XmlElement? bracDretElement =
              _findElementById(document, 'meitatCapDret');
          if (bracDretElement != null) {
            bracDretElement.setAttribute('fill', _pintar);
          }
        }
      case SvgIdentifiers.CAP_ESQUERRE:
        {
          final xml.XmlElement? bracDretElement =
              _findElementById(document, 'meitatCapEsquerre');
          if (bracDretElement != null) {
            bracDretElement.setAttribute('fill', _pintar);
          }
        }
      case SvgIdentifiers.BRAC_ESQUERRE:
        {
          final xml.XmlElement? bracDretElement =
              _findElementById(document, 'meitatBracEsquerre');
          if (bracDretElement != null) {
            bracDretElement.setAttribute('fill', _pintar);
          }
        }
      case SvgIdentifiers.PANXA_ESQUERRE:
        {
          final xml.XmlElement? bracDretElement =
              _findElementById(document, 'meitatPanxaEsquerre');
          if (bracDretElement != null) {
            bracDretElement.setAttribute('fill', _pintar);
          }
        }
      case SvgIdentifiers.CADERA:
        {
          final xml.XmlElement? bracDretElement =
              _findElementById(document, 'meitatCadera');
          if (bracDretElement != null) {
            bracDretElement.setAttribute('fill', _pintar);
          }
        }
      case SvgIdentifiers.CAMA_ESQUERRE:
        {
          final xml.XmlElement? bracDretElement =
              _findElementById(document, 'meitatCamaEsquerre');
          if (bracDretElement != null) {
            bracDretElement.setAttribute('fill', _pintar);
          }
        }
      case SvgIdentifiers.CAMA_DRETA:
        {
          final xml.XmlElement? bracDretElement =
              _findElementById(document, 'meitatCamaDreta');
          if (bracDretElement != null) {
            bracDretElement.setAttribute('fill', _pintar);
          }
        }
      case SvgIdentifiers.PANXA_DRETA:
        {
          final xml.XmlElement? bracDretElement =
              _findElementById(document, 'meitatPanxaDreta');
          if (bracDretElement != null) {
            bracDretElement.setAttribute('fill', _pintar);
          }
        }
      case SvgIdentifiers.BRAC_DRET:
        {
          final xml.XmlElement? bracDretElement =
              _findElementById(document, 'meitatBracDret');
          if (bracDretElement != null) {
            bracDretElement.setAttribute('fill', _pintar);
          }
        }
